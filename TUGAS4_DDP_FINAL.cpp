...
void daftarMenu(){
	...
	for(int i=0; i < indexMenu; i++){ 
		...
		cout << "Nama Hidangan: "<< menu[i].namaMakanan << endl;
...
void pelanggan(){
	...
	cout << "Hari transaksi: ";
	cin >> hari;
	cout << "Jumlah item yang akan dibeli: " << endl;
	cin >> jmlhItem;
	...
	cout << "========================================" << endl;
	cout << "========================================" << endl;
	cout << "YEAY PROGRAM SELESAI, JANGAN DATANG LAGI" << endl;
	lanjut = "selesai";
}
